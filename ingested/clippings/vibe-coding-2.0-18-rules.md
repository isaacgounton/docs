...
This cannot be overstated. Building your own payment system is not a flex. It's a liability.
...
If you're building your first or fifth MVP and want to see how we apply this to client projects, my contact info is in my bio. First call is always just to understand your problem, nothing else.
